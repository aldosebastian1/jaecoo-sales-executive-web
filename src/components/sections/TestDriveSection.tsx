        ...
        <div className="relative z-10 max-w-[1440px] mx-auto px-4 sm:px-[60px] flex flex-col lg:flex-row justify-between gap-10 items-stretch">
            ...
            <div className="w-full lg:w-[50%] xl:w-[55%] 2xl:w-[60%] flex flex-col justify-between">
                <ScrollReveal delay={0.1} variant="slide-up">
                    <span className="font-geist text-[#0F7A83] text-[12px] md:text-[14px] font-semibold uppercase tracking-[0.2em] block mb-4">
                        TEST DRIVE
                    </span>
                    <h2 className="font-geist font-light text-3xl md:text-[42px] lg:text-[48px] text-gray-900 tracking-[-0.03em] leading-[1.1] mb-6 uppercase">
                        Rasakan Sendiri <span className="font-medium text-[#0F7A83]">Performa Jaecoo</span> di Setiap Perjalanan.
                    </h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-4 lg:gap-6">
                        ...
                        <div className="flex flex-col gap-2">
                            <div className="flex items-center gap-2">
                                <svg className="text-[#0F7A83]" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
