        ...
        <div className="flex flex-wrap lg:flex-nowrap justify-between gap-y-10 gap-x-2 lg:gap-4 xl:gap-10 mb-8">
          ...
          <div className="w-full lg:max-w-[260px] flex flex-col">
            ...
            <WhatsAppButton 
              ...
              className="inline-flex items-center justify-center gap-2 bg-primary hover:bg-[#0c626a] text-white px-6 py-3.5 rounded-full font-semibold transition-all duration-300 w-full sm:w-fit text-sm shadow-lg shadow-primary/20"
            >
