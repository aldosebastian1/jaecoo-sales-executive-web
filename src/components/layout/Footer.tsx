    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 xl:px-10 relative z-10">
        <div className="flex flex-col lg:flex-row justify-between gap-8 lg:gap-4 xl:gap-10 mb-6">
          ...
          <div className="flex flex-col items-start lg:max-w-[280px] xl:max-w-[320px]">
            ...
            <div className="flex items-center gap-4">
              {/* Instagram */}
              <a href="https://www.instagram.com/Jaecoomedan.bastian/" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:text-[#0F7A83] transition-colors p-1" aria-label="Instagram">
              ...
              {/* Facebook */}
              <a href="https://www.facebook.com/DealerJaecooMedan/" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:text-[#0F7A83] transition-colors p-1" aria-label="Facebook">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
              </a>
              {/* YouTube */}
              <a href="#" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:text-[#0F7A83] transition-colors p-1" aria-label="YouTube">
              ...
              {/* TikTok */}
              <a href="https://www.tiktok.com/@Jaecoomedan.bastian?_r=1&_t=ZS-970aVRrpiHk" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:text-[#0F7A83] transition-colors p-1" aria-label="TikTok">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col space-y-2 text-gray-800 font-inter text-sm font-medium mb-3">
              ...
              <div className="flex flex-col items-start gap-1 mt-1">
                ...
                <LocationPopup>
                  <span className="font-inter font-bold text-[#0F7A83] hover:text-white transition-colors ml-8 mt-1 block">
                    Cari Dealer
                  </span>
                </LocationPopup>
              </div>
          ...
          <div className="flex flex-col lg:max-w-[260px]">
            ...
            <WhatsAppButton 
              ...
              className="inline-flex items-center justify-center gap-2 bg-[#0F7A83] hover:bg-[#0c626a] text-white px-6 py-3 rounded-full font-semibold transition-all duration-300 w-fit text-sm shadow-lg shadow-[#0F7A83]/20"
            >
        ...
        <div className="border-t border-gray-900 pt-4 mt-4 flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          >
            Designed & Developed by <span className="text-[#0F7A83] group-hover:text-[#0c626a] transition-colors">Aldodev</span>
          </a>
        </div>
      </div>
    </motion.footer>
