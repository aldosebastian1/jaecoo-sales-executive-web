  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 xl:px-10 relative z-10">
        {/* Main Footer Layout: Wrapped on mobile, single row on desktop */}
        <div className="flex flex-wrap lg:flex-nowrap justify-between gap-y-10 gap-x-2 lg:gap-4 xl:gap-10 mb-8">
          
          {/* Column 1: Brand, Desc, Social */}
          <div className="w-full lg:max-w-[280px] xl:max-w-[320px] flex flex-col items-start">
            ...
            <p className="font-inter text-gray-900 text-sm leading-relaxed mb-5 font-medium pr-4 md:pr-0">
            ...
            <div className="flex items-center gap-4">
              ...
              {/* YouTube */}
              <a href="https://www.youtube.com/results?search_query=jaecoo+medan" target="_blank" rel="noopener noreferrer" className="text-gray-900 hover:text-primary transition-colors p-1" aria-label="YouTube">
          ...
          <div className="w-[45%] lg:w-auto flex flex-col">
            ...
            <div className="flex flex-col space-y-4 text-gray-800 font-inter text-sm font-medium">
              <p className="flex items-start gap-3">
                ...
                <span className="hover:text-black transition-colors cursor-pointer break-words">0812-3456-7890</span>
              </p>
              <p className="flex items-start gap-3">
                ...
                <span className="hover:text-black transition-colors cursor-pointer break-words">cs@jaecoomedan.com</span>
              </p>
              <div className="flex flex-col items-start gap-1 mt-1">
                ...
                <LocationPopup>
                  <span className="font-inter font-bold text-primary hover:text-white transition-colors ml-8 block border border-primary/20 bg-primary/5 px-3 py-1 rounded text-xs">
                    Cari Dealer
                  </span>
                </LocationPopup>
              </div>
          ...
          {/* Column 6: CTA */}
          <div className="w-full lg:max-w-[260px] flex flex-col">
            <h3 className="font-inter text-xs font-bold text-black uppercase tracking-widest mb-3">
              Informasi Terbaru
            </h3>
            <p className="font-inter text-gray-800 text-sm font-medium leading-relaxed mb-4">
            ...
            <WhatsAppButton 
              ...
              className="inline-flex items-center justify-center gap-2 bg-primary hover:bg-primary-800 text-white px-6 py-3.5 rounded-full font-semibold transition-all duration-300 w-full sm:w-fit text-sm shadow-lg shadow-primary/20"
            >
        ...
        <div className="border-t border-gray-200 pt-5 mt-4 flex flex-col md:flex-row items-center md:items-start justify-between gap-3">
          ...
          >
            Designed & Developed by <span className="text-gray-900 font-bold group-hover:text-primary transition-colors">Aldodev</span>
          </a>
        </div>
      </div>
    </motion.footer>
