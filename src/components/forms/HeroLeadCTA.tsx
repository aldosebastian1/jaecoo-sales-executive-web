              ...
              >
                ...
                <div className="mb-6 mt-2 text-left">
                    ...
                    <form className="space-y-4" onSubmit={handleSubmit}>
                        ...
                        <button type="submit" className="w-full bg-primary text-white font-inter font-semibold uppercase tracking-widest text-[13px] py-4 rounded-full hover:bg-primary-800 hover:-translate-y-0.5 transition-all duration-300 mt-2 flex items-center justify-center gap-2">
